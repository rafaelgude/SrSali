...
public interface ReservaRepository extends JpaRepository<Reserva, Integer> {
    ...
    @Query(value = "select res "
                 + "from Reserva res inner join fetch res.ambiente amb "
    ...
    Page<Reserva> findAllByInstituicao(Pageable pageable, @Param("instituicao") InstituicaoDeEnsino instituicao, @Param("tipoAmbiente") TipoAmbiente tipoAmbiente, @Param("ambientes") List<Integer> ambientes);
